...
describe('breakpointsToSegments', () => {
  ...
  it('con windZones, calcola il vento efficace al punto medio di ogni segmento (percorso rettilineo verso nord)', () => {
    ...
    const windZones: WindZoneBoundary[] = [
      { id: 'w-start', distKm: 0, fixed: 'start', speedKmh: null, directionDeg: null, timeSamples: [], timeSamplesEnabled: true },
      { id: 'w-finish', distKm: 20, fixed: 'finish', speedKmh: 20, directionDeg: 0, timeSamples: [], timeSamplesEnabled: true }
    ];
...
describe('buildFineGrid', () => {
  ...
  it('con windZones, ogni segmento fine porta il proprio windKmh coerente con la zona attiva', () => {
    ...
    const windZones: WindZoneBoundary[] = [
      { id: 'w-start', distKm: 0, fixed: 'start', speedKmh: null, directionDeg: null, timeSamples: [], timeSamplesEnabled: true },
      { id: 'w-mid', distKm: 5, fixed: false, speedKmh: 15, directionDeg: 180, timeSamples: [], timeSamplesEnabled: true }, // in coda marciando verso nord
      { id: 'w-finish', distKm: 10, fixed: 'finish', speedKmh: 15, directionDeg: 0, timeSamples: [], timeSamplesEnabled: true } // in testa
    ];
