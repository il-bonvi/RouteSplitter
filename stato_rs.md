...
**Fase attuale:** vento a zone completo end-to-end: bussola sulla mappa, frecce statiche sulla planimetria, fascia testa/coda in altimetria ora perfettamente allineata al grafico (zoom incluso), e ottimizzatore di pacing wind-aware (spinge di più in testa, tira il fiato in coda, a parità di media). Prossimo passo naturale se richiesto: animazione delle frecce vento (effetto "flow"). 107 test verdi, typecheck/build puliti.
